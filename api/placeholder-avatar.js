// api/placeholder-avatar.js (Platzhalter-Bilder)

module.exports = async (req, res) => {
    // Setzt den Content-Type auf SVG-Grafik
    res.setHeader('Content-Type', 'image/svg+xml');
    // Setzt Cache-Control, damit der Browser das Bild einen Tag lang speichert
